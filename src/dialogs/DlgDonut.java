...
public class DlgDonut extends JDialog {
	...
	public DlgDonut() {
		...
		}
		{
			...
			textFieldInnerRadius.setFont(new Font("Tahoma", Font.PLAIN, 25));
			...
			contentPanel.add(textFieldInnerRadius, gbc_textField);
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent Arg0) {
						try {
							int a = Integer.parseInt(textFieldRadius.getText());
							int b = Integer.parseInt(textFieldInnerRadius.getText());
							if(a>b) {
								JOptionPane.showMessageDialog(null, "Outer radius have to be > Inner radius");
							}
							dispose();
